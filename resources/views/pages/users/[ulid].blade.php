    ...
    @if($this->user)
        <div class="bg-white rounded-lg shadow-sm dark:bg-zinc-900 p-6">
            <div class="flex items-center gap-4 mb-6">
                <div class="w-16 h-16 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center text-2xl font-semibold text-zinc-600 dark:text-zinc-400">
                    {{ $this->user->initials() }}
                </div>
                <div>
