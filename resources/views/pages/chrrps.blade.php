...
new class extends Component {
    public string $message = '' /** * @return string[][] * * @psalm-return * *
     * list{array{author: 'Jane Doe', message: 'Just deployed my first Laravel app! 🚀', time: '5 minutes ago'}, array{author: 'John Smith', message: 'Laravel makes web development fun again!', time: '1 hour
     * ago'}, array{author: 'Alice Johnson', message: 'Working on something cool with Chirper...', time: '3 hours ago'}} */;

    public function chrrps(): array
    {
        return [
            ['author' => 'Jane Doe', 'message' => 'Just deployed my first Laravel app! 🚀', 'time' => '5 minutes ago'],
            ['author' => 'John Smith', 'message' => 'Laravel makes web development fun again!', 'time' => '1 hour ago'],
            ['author' => 'Alice
Johnson', 'message' => 'Working on something cool with Chirper...', 'time' => '3 hours ago'],
        ];
    }
