...
final class TeamMoveTest extends TestCase
{
    ...
    public function test_can_move_organisation_to_another_enterprise(): void
    {
        ...
        $this->assertEquals($enterprise1->id, $organisation->parent_id);
        $this->assertEquals($enterprise1->id, $organisation->tenant_id);
        ...
        $this->assertEquals($enterprise2->id, $organisation->parent_id);
        $this->assertEquals($enterprise2->id, $organisation->tenant_id);
    }
