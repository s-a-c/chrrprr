...
- [ ] T001 Install core framework packages (stancl/tenancy, filament/filament) via composer
- [ ] T001.5 [P] Install WireChat package (wirechat/wirechat) via composer
- [ ] T001.6 [P] Install WebSocket packages (laravel/echo, pusher/pusher-php-server) or configure Laravel Reverb via composer
- [ ] T001.7 [P] Install bio markdown packages (spatie/laravel-markdown, stevebauman/purify) via composer
- [ ] T001.8 [P] Install client-side syntax highlighting (highlight.js, @catppuccin/highlightjs) via npm/bun
- [ ] T001.9 [P] Install Tailwind Typography plugin (@tailwindcss/typography) via npm/bun
- [ ] T002 [P] Install ULID support package (symfony/uid:^7.2) via composer
- [ ] T003 [P] Install translatable and slug packages (spatie/laravel-translatable, cviebrock/eloquent-sluggable) via composer
- [ ] T004 [P] Install hierarchical relationships package (staudenmeir/laravel-adjacency-list) via composer
- [ ] T005 [P] Install STI package (tightenco/parental) via composer
- [ ] T006 [P] Install state and status packages (spatie/laravel-model-states, spatie/laravel-model-status) via composer
- [ ] T007 [P] Install permissions package (spatie/laravel-permission) via composer
- [ ] T008 Configure stancl/tenancy in config/tenancy.php
- [ ] T009 Configure bootstrap/app.php with tenancy middleware (InitializeTenancyBySubdomain, PreventAccessFromCentralDomains)
- [ ] T009.5 [P] Configure Laravel Echo and broadcasting driver (Pusher or Reverb) in config/broadcasting.php
- [ ] T009.6 [P] Configure frontend Laravel Echo client in resources/js/app.js
- [ ] T009.7 [P] Configure Spatie markdown with code highlighting disabled in config/markdown.php
- [ ] T009.8 [P] Configure Purify XSS sanitization settings in config/purify.php
- [ ] T009.9 [P] Configure Tailwind CSS v4 with Typography plugin and Catppuccin Mocha theme in resources/css/app.css
- [ ] T010 [P] Configure Laravel Pint in pint.json
- [ ] T011 [P] Configure PHPStan level 9 in phpstan.neon
...
- [ ] T012 Create migration to add ULID and enhanced columns to users table in database/migrations/YYYY_MM_DD_HHMMSS_add_ulid_to_users.php
- [ ] T012.5 [P] Create migration to add bio column to users table in database/migrations/YYYY_MM_DD_HHMMSS_add_bio_to_users_table.php
- [ ] T013 Create migration to create teams table (STI base) in database/migrations/YYYY_MM_DD_HHMMSS_create_teams_table.php
- [ ] T013.5 [P] Create migration to add bio column to teams table in database/migrations/YYYY_MM_DD_HHMMSS_add_bio_to_teams_table.php
- [ ] T014 Create migration to create domains table in database/migrations/YYYY_MM_DD_HHMMSS_create_domains_table.php
- [ ] T015 Create migration to create user_enterprise pivot table in database/migrations/YYYY_MM_DD_HHMMSS_create_user_enterprise_table.php
- [ ] T016 Create migration to create user_organisation_access pivot table in database/migrations/YYYY_MM_DD_HHMMSS_create_user_organisation_access_table.php
- [ ] T017 Run all migrations to verify schema creation

### Traits (Reusable Model Concerns)

- [ ] T018 [P] Create HasUlid trait in app/Models/Concerns/HasUlid.php
- [ ] T019 [P] Create HasTranslatableAttributes trait in app/Models/Concerns/HasTranslatableAttributes.php
- [ ] T020 [P] Create HasTranslatableSlug trait in app/Models/Concerns/HasTranslatableSlug.php

### Enums

- [ ] T021 [P] Create UserState enum in app/Enums/UserState.php
- [ ] T022 [P] Create UserStatus enum in app/Enums/UserStatus.php
- [ ] T023 [P] Create TeamType enum in app/Enums/TeamType.php
- [ ] T024 [P] Create TeamState enum in app/Enums/TeamState.php
- [ ] T025 [P] Create TeamStatus enum in app/Enums/TeamStatus.php

### Base Models

- [ ] T026 Create base Team model (STI) in app/Models/Team.php
- [ ] T027 Create Domain model in app/Models/Domain.php
- [ ] T028 Update User model with ULID, translatable attributes, and tenant relationship in app/Models/User.php

### Factories and Seeders

- [ ] T029 [P] Create UserFactory with ULID and enhanced attributes in database/factories/UserFactory.php
- [ ] T030 [P] Create EnterpriseFactory in database/factories/EnterpriseFactory.php
- [ ] T031 [P] Create OrganisationFactory in database/factories/OrganisationFactory.php
- [ ] T032 [P] Create DivisionFactory in database/factories/DivisionFactory.php
- [ ] T033 [P] Create DepartmentFactory in database/factories/DepartmentFactory.php
- [ ] T034 [P] Create ProjectFactory in database/factories/ProjectFactory.php

### Foundational Tests

- [ ] T035 [P] Create unit test for HasUlid trait in tests/Unit/Models/Concerns/HasUlidTest.php
- [ ] T036 [P] Create unit test for HasTranslatableAttributes trait in tests/Unit/Models/Concerns/HasTranslatableAttributesTest.php
- [ ] T037 [P] Create unit test for HasTranslatableSlug trait in tests/Unit/Models/Concerns/HasTranslatableSlugTest.php
- [ ] T038 [P] Create unit test for UserState enum in tests/Unit/Enums/UserStateTest.php
- [ ] T039 [P] Create unit test for TeamType enum in tests/Unit/Enums/TeamTypeTest.php
- [ ] T040 Create feature test for database migrations in tests/Feature/Database/MigrationsTest.php

**Checkpoint**: Foundation ready - user story implementation can now begin in parallel

---

## Phase 3: User Story 1 - Team Hierarchy Management (Priority: P1) 🎯 MVP
...
- [ ] T041 [P] [US1] Create feature test for Enterprise creation in tests/Feature/Teams/EnterpriseCreationTest.php
- [ ] T042 [P] [US1] Create feature test for Organisation creation in tests/Feature/Teams/OrganisationCreationTest.php
- [ ] T043 [P] [US1] Create feature test for Division creation in tests/Feature/Teams/DivisionCreationTest.php
- [ ] T044 [P] [US1] Create feature test for Department creation in tests/Feature/Teams/DepartmentCreationTest.php
- [ ] T045 [P] [US1] Create feature test for Project creation in tests/Feature/Teams/ProjectCreationTest.php
- [ ] T046 [P] [US1] Create feature test for hierarchy validation rules in tests/Feature/Teams/HierarchyValidationTest.php
- [ ] T047 [P] [US1] Create feature test for unique name validation in tests/Feature/Teams/UniqueNameValidationTest.php
- [ ] T048 [P] [US1] Create feature test for executive/deputy constraints in tests/Feature/Teams/ExecutiveDeputyConstraintsTest.php
- [ ] T048.5 [P] [US1] Create feature test for user deletion prevention when executive/deputy in tests/Feature/Teams/UserDeletionPreventionTest.php
- [ ] T049 [P] [US1] Create feature test for state transitions in tests/Feature/Teams/StateTransitionsTest.php
- [ ] T050 [P] [US1] Create feature test for hierarchical slug generation in tests/Feature/Teams/HierarchicalSlugTest.php
- [ ] T050.5 [P] [US1] Create feature test for team bio editing permissions in tests/Feature/Teams/TeamBioPermissionsTest.php
- [ ] T050.6 [P] [US1] Create feature test for team bio markdown rendering and syntax highlighting in tests/Feature/Teams/TeamBioRenderingTest.php
- [ ] T050.7 [P] [US1] Create feature test for team bio XSS sanitization in tests/Feature/Teams/TeamBioSanitizationTest.php
- [ ] T050.8 [P] [US1] Create feature test for team bio size limits (soft and hard) in tests/Feature/Teams/TeamBioSizeLimitsTest.php

### Implementation for User Story 1

- [ ] T051 [P] [US1] Create Enterprise model (implements TenantContract) in app/Models/Enterprise.php
- [ ] T052 [P] [US1] Create Organisation model in app/Models/Organisation.php
- [ ] T053 [P] [US1] Create Division model in app/Models/Division.php
- [ ] T054 [P] [US1] Create Department model in app/Models/Department.php
- [ ] T055 [P] [US1] Create Project model in app/Models/Project.php
- [ ] T056 [US1] Implement hierarchy validation in Team model (parent-child type constraints, tenant-configurable soft limit default 5, hard limit 10) in app/Models/Team.php
- [ ] T057 [US1] Implement unique name validation (per parent+type within enterprise) in app/Models/Team.php
- [ ] T058 [US1] Implement executive/deputy constraint validation in app/Models/Team.php
- [ ] T058.5 [US1] Implement model observer to prevent user deletion when referenced as executive/deputy in app/Observers/UserObserver.php
- [ ] T059 [US1] Implement state machine for Team states in app/Models/Team.php
- [ ] T060 [US1] Create StoreTeamRequest form request with validation rules in app/Http/Requests/StoreTeamRequest.php
- [ ] T061 [US1] Create UpdateTeamRequest form request with validation rules in app/Http/Requests/UpdateTeamRequest.php
- [ ] T062 [US1] Create CreateTeam Livewire component in app/Livewire/Teams/CreateTeam.php
- [ ] T063 [US1] Create EditTeam Livewire component in app/Livewire/Teams/EditTeam.php
- [ ] T064 [US1] Create TeamList Livewire component in app/Livewire/Teams/TeamList.php
- [ ] T065 [US1] Create Folio page for teams index in resources/views/pages/teams/index.blade.php
- [ ] T066 [US1] Create Folio page for team creation in resources/views/pages/teams/create.blade.php
- [ ] T067 [US1] Create Folio page for team editing in resources/views/pages/teams/[ulid].blade.php
- [ ] T068 [US1] Create Livewire view for CreateTeam in resources/views/livewire/teams/create-team.blade.php
- [ ] T069 [US1] Create Livewire view for EditTeam in resources/views/livewire/teams/edit-team.blade.php
- [ ] T070 [US1] Create Livewire view for TeamList in resources/views/livewire/teams/team-list.blade.php
- [ ] T071 [US1] Implement optimistic locking for concurrent modifications in app/Models/Team.php
- [ ] T072 [US1] Add error handling and user-friendly error messages in app/Livewire/Teams/CreateTeam.php and app/Livewire/Teams/EditTeam.php
- [ ] T072.5 [P] [US1] Create feature test for team move/reparenting in tests/Feature/Teams/TeamMoveTest.php
- [ ] T072.6 [P] [US1] Create feature test for cycle prevention in team moves in tests/Feature/Teams/TeamMoveCyclePreventionTest.php
- [ ] T072.7 [P] [US1] Create feature test for team move approval workflow in tests/Feature/Teams/TeamMoveApprovalTest.php
- [ ] T072.8 [US1] Implement team move/reparenting validation (prevent cycles, depth violations, cross-tenant moves) in app/Models/Team.php
- [ ] T072.9 [US1] Implement approval workflow for significant team moves with configurable thresholds in app/Services/TeamMoveService.php
- [ ] T072.10 [US1] Create MoveTeamRequest form request with validation in app/Http/Requests/MoveTeamRequest.php
- [ ] T072.11 [US1] Create MoveTeam Livewire component in app/Livewire/Teams/MoveTeam.php
- [ ] T072.12 [US1] Create Livewire view for team move in resources/views/livewire/teams/move-team.blade.php
- [ ] T072.13 [P] [US1] Create feature test for bulk team operations in tests/Feature/Teams/BulkTeamOperationsTest.php
- [ ] T072.14 [US1] Create bulk create/update API endpoint with DTOs and partial success handling in app/Http/Controllers/Teams/BulkTeamController.php
- [ ] T072.15 [US1] Create BulkTeamRequest DTO in app/Http/Requests/BulkTeamRequest.php
- [ ] T072.16 [US1] Implement partial success response format for bulk operations in app/Http/Controllers/Teams/BulkTeamController.php
- [ ] T072.16.5 [US1] Add tenant-configurable bulk operation batch size field (default 500 items) to Enterprise model in app/Models/Enterprise.php
- [ ] T072.16.6 [US1] Implement batch size validation using tenant-configurable limit in app/Http/Controllers/Teams/BulkTeamController.php
- [ ] T072.17 [P] [US1] Verify bio column is included in teams table migration (T013.5)
- [ ] T072.18 [US1] Implement bio attribute (longText, nullable) in app/Models/Team.php
- [ ] T072.19 [US1] Implement bio sanitization using Purify before storage in app/Models/Team.php
- [ ] T072.20 [US1] Integrate bio editing in Filament Team resource using MarkdownEditor component in app/Filament/Resources/TeamResource.php
- [ ] T072.21 [US1] Implement role-based bio editing permissions (Team Executive, Enterprise/Organisation Admins) in app/Policies/TeamPolicy.php
- [ ] T072.22 [US1] Implement bio display on team profile pages with markdown rendering and syntax highlighting in resources/views/pages/teams/[ulid].blade.php
- [ ] T072.23 [US1] Implement bio size limit validation (tenant-configurable soft limit default 10K, hard limit 50K) in app/Http/Requests/StoreTeamRequest.php and app/Http/Requests/UpdateTeamRequest.php
- [ ] T072.24 [US1] Implement empty bio placeholder handling in resources/views/pages/teams/[ulid].blade.php
- [ ] T072.25 [US1] Add client-side syntax highlighting initialization for bio code blocks in resources/js/app.js
- [ ] T072.26 [US1] Create performance test for bio markdown rendering (<100ms for 95% of requests) validating SC-011 in tests/Feature/Performance/BioRenderingPerformanceTest.php
- [ ] T072.27 [US1] Create performance test for syntax highlighting (<500ms after page load) validating SC-012 in tests/Feature/Performance/SyntaxHighlightingPerformanceTest.php
...
## Phase 4: User Story 2 - Context Switching (Priority: P2)
...
- [ ] T073 [P] [US2] Create feature test for context switching in tests/Feature/Context/ContextSwitchingTest.php
...
- [ ] T079 [US2] Add context scoping local scope (scopeInContext) to Team model in app/Models/Team.php
- [ ] T080 [US2] Add withoutContextScope method for privileged users in app/Models/Team.php
- [ ] T081 [US2] Create SwitchContextRequest form request with validation in app/Http/Requests/SwitchContextRequest.php
- [ ] T082 [US2] Create SwitchContext Livewire component in app/Livewire/Context/SwitchContext.php
- [ ] T083 [US2] Implement context switching logic in User model (setCurrentContext method) in app/Models/User.php
- [ ] T084 [US2] Implement context validation (user must have access to organisation) in app/Models/User.php
...
- [ ] T086 [US2] Create Livewire view for context switcher in resources/views/livewire/context/switch-context.blade.php
...
## Phase 5: User Story 3 - Enhanced User Attributes (Priority: P3)
...
- [ ] T096 [US3] Integrate all User model enhancements (coordinate T097, T098, T099, T100) in app/Models/User.php
- [ ] T097 [US3] Implement state machine for User states in app/Models/User.php
- [ ] T098 [US3] Implement status tracking for User statuses in app/Models/User.php
- [ ] T099 [US3] Implement user-enterprise many-to-many relationship in app/Models/User.php
- [ ] T100 [US3] Implement user-organisation access many-to-many relationship in app/Models/User.php
...
- [ ] T105.5 [P] [US3] Verify bio column is included in users table migration (T012.5)
- [ ] T105.6 [US3] Implement bio attribute (longText, nullable) in app/Models/User.php
- [ ] T105.7 [US3] Implement bio sanitization using Purify before storage in app/Models/User.php
...
- [ ] T225 [P] Create Architectural Decision Records (ADRs) document in docs/adr/ documenting key decisions (ULID vs integer, STI vs separate tables, subdomain tenancy, WireChat extension pattern)
...
## Phase 8: User Story 4 - Presence Status and Monitoring (Priority: P2)
...
## Phase 9: User Story 5 - Follow Users and Teams (Priority: P3)
...
## Phase 10: User Story 6 - Online Chat Capabilities (Priority: P2)
...
- [ ] T208 [US6] Configure WireChat package in config/wirechat.php (publish config if needed)
- [ ] T209 [US6] Run WireChat installation command: `php artisan wirechat:install`
- [ ] T210 [US6] Run WireChat migrations: `php artisan migrate`
- [ ] T211 [US6] Publish WireChat views: `php artisan vendor:publish --tag=wirechat-views`
- [ ] T212 [P] [US6] Create extended Conversation model extending WireChat Conversation in app/Models/Chat/Conversation.php
- [ ] T213 [US6] Configure WireChat to use extended Conversation model in config/wirechat.php
...
- [ ] T215 [US6] Create extended ChatList Livewire component extending WireChat Chats in app/Livewire/Chat/ChatList.php
- [ ] T216 [US6] Create extended ChatWindow Livewire component extending WireChat Chat in app/Livewire/Chat/ChatWindow.php
- [ ] T217 [US6] Create ChatWidget Livewire component for embedding chat in pages in app/Livewire/Chat/ChatWidget.php
- [ ] T218 [US6] Customize WireChat views for tenant-aware conversation filtering in resources/views/vendor/wirechat/
...
- [ ] T221 [US6] Implement chat access validation (prevent messages when sender loses access) in app/Livewire/Chat/ChatWindow.php
- [ ] T222 [US6] Configure real-time message delivery via WebSocket connections (Laravel Echo/Pusher) in app/Livewire/Chat/ChatWindow.php
- [ ] T222.5 [US6] Create Laravel broadcasting event for chat messages in app/Events/ChatMessageSent.php
- [ ] T222.6 [US6] Configure WebSocket channel authorization for chat channels (per-channel subscription authorization) in app/Broadcasting/ChatChannel.php
...
- [ ] T222.6.6 [US6] Implement WebSocket polling fallback for chat messages (poll every 5-10 seconds when WebSocket unavailable) in app/Livewire/Chat/ChatWindow.php
- [ ] T222.6.7 [US6] Implement chat message character limit validation (tenant-configurable default 10,000 characters, system maximum 50,000 characters) in app/Http/Requests/SendChatMessageRequest.php or app/Livewire/Chat/ChatWindow.php
- [ ] T222.6.8 [US6] Add tenant-configurable chat message character limit field (default 10,000 characters) to Enterprise model in app/Models/Enterprise.php
- [ ] T222.6.9 [US6] Create feature test for chat message size limit validation in tests/Feature/Chat/ChatMessageSizeLimitTest.php
...
- [ ] T224 [US6] Add chat widget to navigation/layout in resources/views/components/navbar.blade.php or similar

**Checkpoint**: At this point, User Story 6 should be fully functional and testable independently. Users can initiate one-on-one and team chat conversations, send/receive messages in real-time, view conversation history, and see read receipts and unread counts.
...
- **User Story 6 (Phase 10)**: Depends on Setup (WireChat package) and Foundational phase completion - Can start after Phase 1 and Phase 2
...
- **User Story 6 (P2)**: Can start after Setup (Phase 1 - WireChat package) and Foundational (Phase 2) - Requires WireChat package installation
...
- User Story 6 can start after Setup (WireChat) and Foundational phases complete
...
- **Total Tasks**: 360
- **Phase 1 (Setup)**: 21 tasks (added WireChat, WebSocket infrastructure, bio markdown packages, and configuration)
- **Phase 2 (Foundational)**: 33 tasks (added bio column migrations: T012.5, T013.5)
- **Phase 3 (User Story 1)**: 63 tasks (17 tests + 46 implementation, added bio support for teams)
- **Phase 4 (User Story 2)**: 17 tasks (6 tests + 11 implementation)
- **Phase 5 (User Story 3)**: 29 tasks (10 tests + 19 implementation, added bio support for users)
...
- **Phase 10 (User Story 6 - Chat)**: 38 tasks (11 tests + 27 implementation, added WebSocket infrastructure, polling fallback, per-message validation, message size limits, and retention cleanup)

### MVP Scope (User Story 1 Only)

- **MVP Tasks**: 115 tasks (Phases 1, 2, 3)
